            ...
            >
              ...
              <div class="xxl:flex mt-5 mb-3">
                <div class="flex items-center justify-center sm:justify-start">
                  <div
                    class="relative text-2xl xxl:text-3xl font-medium leading-6 pl-3 xxl:pl-4"
                  >
                    <span
                      class="absolute text-xl xxl:text-2xl top-0 left-0 -mt-1 xxl:mt-0"
                      >$</span
                    >
                    18,402,210
                  </div>
              ...
              <div class="flex flex-wrap items-center">
                ...
                >
                  ...
                  <div class="ml-3.5">
                    ...
                    >
                      <span
                        class="absolute text-base xxl:text-xl top-0 left-0 xxl:-mt-1.5"
                        >$</span
                      >
                      47,578.77
                    </div>
